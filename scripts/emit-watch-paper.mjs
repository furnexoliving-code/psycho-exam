...
const paper = {
  ...
  instructions: [
    ...
    bi(
      "This test is answered with the keyboard. Press 1 to 5 to choose an option, and the arrow keys to move between questions. The mouse is switched off during the test.",
      "यह परीक्षण कीबोर्ड से हल किया जाता है। विकल्प चुनने के लिए 1 से 5 दबाएँ, और प्रश्नों के बीच जाने के लिए तीर कुंजियाँ दबाएँ। परीक्षण के दौरान माउस बंद रहता है।",
    ),
  ],
  example: {
    table: tables[0],
