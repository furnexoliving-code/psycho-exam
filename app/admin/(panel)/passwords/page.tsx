 ...
 * no papers, no account creation, no switching off. The one section a staff
 * account may open; the admin has it too, since with thousands of students
 * a search is the quick way to one of them.
 */
export default async function PasswordsPage({
  ...
  await requireStaff("/admin/passwords");
